...
namespace Microsoft.Extensions.Configuration
{
    ...
    ///     /// Attempts to bind the configuration instance to a new instance of type T.
        ...
        private static object CreateInstance(Type type)
        {
            ...
            {
                throw new InvalidOperationException("FormatError_CannotActivateAbstractOrInterface(type)");
            }
            ...
            if (type.IsArray)
            {
                ...
                {
                    throw new InvalidOperationException("FormatError_UnsupportedMultidimensionalArray(type)");
                }
            ...
            {
                throw new InvalidOperationException("FormatError_MissingParameterlessConstructor(type)");
            }
            ...
            {
                throw new InvalidOperationException("FormatError_FailedToActivate(type)", ex);
            }
        }
        ...
        private static object ConvertValue(Type type, string value)
        {
            ...
            {
                throw new InvalidOperationException("FormatError_FailedBinding(value, type)", ex);
            }
        }
